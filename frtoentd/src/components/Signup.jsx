                ...
                <div className="max-w-md w-full backdrop-blur-lg bg-white/90 rounded-2xl shadow-2xl transform transition-all duration-300 hover:shadow-3xl">
                    <div className="p-8">
                        <div className="text-center mb-8 animate-fade-in">
                            ...
                            <p className="text-gray-600 mt-2">Join our design community</p>
                        </div>

                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="relative group animate-slide-up" style={{ animationDelay: '200ms' }}>
                                <User className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 transition-colors duration-200 group-focus-within:text-blue-600" size={20} />
                                <input
                                    type="text"
                                    name="username"
                            ...
                            <div className="text-sm text-gray-600 animate-slide-up" style={{ animationDelay: '800ms' }}>
                                By signing up, you agree to our
                                <a href="#terms" className="text-blue-600 hover:text-blue-700 mx-1">Terms of Service</a>
                                and
                                <a href="#privacy" className="text-blue-600 hover:text-blue-700 mx-1">Privacy Policy</a>
                            </div>
                            ...
                            <div className="text-center text-gray-600 text-sm animate-slide-up" style={{ animationDelay: '1200ms' }}>
